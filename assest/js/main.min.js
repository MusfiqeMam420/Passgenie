const lengthSlider = document.querySelector(".pass-length input"),
  ...
  copyIcon = document.querySelector(".input__area span"),
  passwordInput = document.querySelector(".input__area input"),
  passIndicator = document.querySelector(".color__identity"),
  passIndicator2 = document.querySelector(".input__area"),
...
const updateSlider = () => {
  ...
  upadatePassIndicatorr();
};
updateSlider();

const copyPassword = () => {
  navigator.clipboard.writeText(passwordInput.value); // copying random password
  copyIcon.innerHTML = "<i class='bg-checkmark-outline-1'></i>"; // changing copy icon to tick
  copyIcon.style.color = "#1ba355";
  setTimeout(() => {
    // after 1500 ms, changing tick icon back to copy
    copyIcon.innerHTML = "<i class='bg-clipboard-outline-1'></i>";
    copyIcon.style.color = "#484848";
  }, 1500);
};
